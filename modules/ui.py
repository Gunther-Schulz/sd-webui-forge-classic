                ...
                for category in ordered_ui_categories():
                    if category == "prompt":
                        ...
                        with gr.Row(elem_id="txt2img_sigma_shift_row"):
                            sigma_shift = gr.Slider(minimum=0.5, maximum=8.0, step=0.01, label="Sigma Shift", value=1.15, elem_id="txt2img_sigma_shift", info="Flow Match noise schedule", visible=False)
                ...
                for category in ordered_ui_categories():
                    ...
                    if category == "image":
                        ...
                        with gr.Row(elem_id="img2img_sigma_shift_row"):
                            img2img_sigma_shift = gr.Slider(minimum=0.5, maximum=8.0, step=0.01, label="Sigma Shift", value=1.15, elem_id="img2img_sigma_shift", info="Flow Match noise schedule", visible=False)
